...
public class ARPGUI extends JFrame implements BaseLayer {
	...
	public static void main(String[] args) {
		...
		System.out.println(((EthernetLayer) m_LayerMgr.GetLayer("Ethernet")).GetUpperLayer(1).GetUpperLayer(0).GetLayerName());
	    //System.out.println(((IPLayer) m_LayerMgr.GetLayer("IP")).GetUnderLayer(1).GetLayerName());
	    //System.out.println(((IPLayer) m_LayerMgr.GetLayer("IP")).GetUpperLayer(0).GetLayerName());
	    System.out.println("-------------------------------");
	    System.out.println(((TCPLayer) m_LayerMgr.GetLayer("TCP")).GetUnderLayer(0).GetLayerName());
	    System.out.println(((IPLayer) m_LayerMgr.GetLayer("IP")).GetUpperLayer(0).GetLayerName());
	    System.out.println("-------------------------------");
